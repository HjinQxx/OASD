...
4. API 관리 및 용이한 데이터 처리를 위해 지도 사용 범위는 서울과 경기도로 제한되어있습니다.
5. API 관리를 위해 일일 사용량을 제한해두었습니다.
6. 마을버스 및 일부 지하철의 경우 실제 지도앱에서도 실시간 정보가 확인되지 않는 경우가 있습니다.
   위의 앱에서도 간혹 실시간 정보가 확인되지 않거나, 약간의 차이가 있을 수 있습니다.
